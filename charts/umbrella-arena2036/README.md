...
- http://sharedidp.arena.test/auth/
- http://portal-backend.arena.test
  - http://portal-backend.arena.test/api/administration/swagger/index.html
  - http://portal-backend.arena.test/api/registration/swagger/index.html
  - http://portal-backend.arena.test/api/apps/swagger/index.html
  - http://portal-backend.arena.test/api/services/swagger/index.html
  - http://portal-backend.arena.test/api/notification/swagger/index.html
- http://portal.arena.test
- http://managed-identity-wallets.arena.test/ui/swagger-ui/index.html
- http://semantics.arena.test/discoveryfinder/swagger-ui/index.html
